...
void MSync(const FunctionCallbackInfo<Value>& args);
void MRemap(const FunctionCallbackInfo<Value>& args);
...
void GetAddressShared(const FunctionCallbackInfo<Value> &args);
