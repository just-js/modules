...
void CreateTableOptions(const FunctionCallbackInfo<Value> &args);
...
void DestroyTableOptions(const FunctionCallbackInfo<Value> &args);
...
void AllowMmapReads(const FunctionCallbackInfo<Value> &args);
